...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="app-ecommerce">
            ...
            <form id="addProductForm" action="{{ route('product.update', ['id' => $product->id]) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <textarea id="editor" class="form-control" aria-label="With textarea" data-gramm="false" wt-ignore-input="true"
                                        data-quillbot-element="BRMw-EL30SE9sNAVLeCFM" name="productDescription">{{ $product->description }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /Product Information -->
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="author" placeholder="jon doe"
                                        name="author" aria-label="Author" value="{{ $product->productSeo->author }}" />
                                    @error('author')
                                        <div class="text-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control" aria-label="With textarea" data-gramm="false" wt-ignore-input="true"
                                        data-quillbot-element="BRMw-EL30SE9sNAVLeCFM" name="metaDescription">{{ $product->productSeo->meta_description }}</textarea>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input id="ecommerce-product-tags" class="form-control" name="keywords"
                                        value="{{ $product->productSeo->keyword }}" aria-label="Product Tags" />
                                    @error('keywords')
                                        <div class="text-danger mt-2">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img src="{{ asset('assets/img/product/' . $product->thumb) }}" alt="user-avatar"
                                    ...
                                    <div class="button-wrapper">
                                        <label for="ProductFile" class="btn btn-primary me-2 mb-4" tabindex="0">
                                            ...
                                            <input type="file" id="ProductFile" class="account-file-input" hidden
                                                accept="zip" name="ProductFile" />
                                        </label>

                                        <p class="text-muted mb-0">
                                            Allowed only zip file
                                        </p>
                                    </div>
                                </div>
                            </div>
